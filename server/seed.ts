...
async function seed() {
  ...
  try {
    ...
    await db.insert(schema.users).values([
      {
        username: "admin",
        password: "$2b$10$K9p7r1z3K9p7r1z3K9p7r1z3K9p7r1z3K9p7r1z3K9p7r1z3K9p7r1", // password: admin
        role: "admin",
      },
    ]);
    ...
    await db.insert(schema.heroSlides).values([
      {
        title: "Welcome to Tuskers Cricket Club",
        description: "Join the legacy of champions",
        date: "2024-01-01",
        image: "/api/placeholder/1200/600",
        isActive: true,
        order: 1,
    ...
    await db.insert(schema.newsArticles).values([
      {
        title: "Season 2024 Registration Open",
        description: "Join us for an exciting cricket season",
        content: "Registration for the 2024 cricket season is now open. Join our team and be part of the Tuskers family!",
        date: "2024-01-15",
        image: "/api/placeholder/600/400",
        isPublished: true,
      },
